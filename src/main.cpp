...
void mouseButtonCallback(GLFWwindow * window, int button, int action, int mods)
{
    ...
    {
        glfwTerminate();
        throw std::invalid_argument(("unknown context state enumerator " + std::to_string(context.state)).c_str());
    }
    }
}
...
void cursorPosCallback(GLFWwindow * window, double xpos, double ypos)
{
    ...
    context.cursorYPos = context.WINDOW_HEIGHT - ypos;  // reverse y coordinate to facilitate debugging
